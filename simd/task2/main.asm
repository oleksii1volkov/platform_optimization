...
section .bss
    input_array_ptr  resd 1         ; Pointer to dynamically allocated input array
...
free_allocated_memory:
    ...
    ; Free the memory for input_array
    push dword [input_array_ptr]
    call free
    add esp, 4
...
add_array_simd:
    ...
    ; [ebp+12] -> Address of the result array
    ...
    mov edx, [ebp+12]        ; Load address of the result array into EDX
...
.simd_loop:
    ...
    ; Load elements from array using SSE
    movdqa xmm0, [esi]       ; Load 4 integers from array into XMM0

    ; Perform SIMD addition
    paddd xmm0, xmm0         ; Add packed integers from XMM0 to XMM0, result in XMM0

    ; Store result back to memory
    movdqa [edx], xmm0       ; Store result into result_array

    ; Advance the pointers by 4 integers (16 bytes)
    add esi, 16              ; Move array pointer by 16 bytes
...
.scalar_loop:
    ...
    add eax, eax             ; Add integer to itself
